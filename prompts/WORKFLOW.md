...
# BEFORE RUNNING: copy your UI screenshots into the project:
...
# Claude Code will open BOTH screenshots automatically (instruction is inside ui.md)
# It MUST study them before writing any code — this ensures pixel-accurate UI
cat prompts/CONTEXT.md prompts/contract/mvi.md \
...
#
# Session C — UI layer:
# BEFORE RUNNING: place UI design screenshot in:
#   app/src/main/assets/screenshots/<feature_name>_screen.png
# Then add this instruction at the TOP of features/<feature_name>/ui.md:
#   # Claude Code MUST open app/src/main/assets/screenshots/<feature_name>_screen.png
#   # before writing any code. Extract colors, spacing, font sizes, and component
#   # shapes directly from the screenshot. Do NOT hardcode — use DesignTokens only.
cat prompts/CONTEXT.md prompts/contract/mvi.md \
prompts/contract/sdui_contract.md \
prompts/contract/sdui_engine.md \
