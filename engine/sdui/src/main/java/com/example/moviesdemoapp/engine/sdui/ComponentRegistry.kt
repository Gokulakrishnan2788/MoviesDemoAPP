...
typealias ComponentFactory =
    @Composable (node: ComponentNode, data: Map<String, String>,  onAction: (currentScreen: String, actionId: String, params: Map<String, String>, action: ActionModel, isBackClickAction: Boolean) -> Unit) -> Unit
