 ...
 */
@Singleton
class BankingFormStateRepository
    @Inject
    constructor(
        ...
        fun checkFormCompleted(formId: String): Boolean = prefs.getBoolean("form_${formId}_completed", false)

        /**
         * Check if a specific form is completed
         */
        fun isFormCompleted(formId: String): Boolean = prefs.getBoolean("form_${formId}_completed", false)

        /**
         * Get the list of all incomplete form IDs
         */
        fun getIncompleteFormIds(): List<String> = formIds.filter { !isFormCompleted(it) }
         ...
         */
        fun getNextIncompleteForm(): String? = getIncompleteFormIds().firstOrNull()
         ...
         * Get saved form data
         */
        fun getFormData(formId: String): String? = prefs.getString("form_${formId}_data", null)
